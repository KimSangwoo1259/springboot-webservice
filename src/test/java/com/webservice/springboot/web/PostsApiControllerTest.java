...
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate; // HTTP 요청 후 데이터를 응답 받을 수 있는 템플릿 객체
    ...
    public void Posts_등록() throws Exception {
        ...
        //when
        ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url,requestDto, Long.class); //Post 요청을 보내고 결과로 ResponseEntity로 반환
